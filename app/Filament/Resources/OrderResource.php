            ...
            ->schema([
                Group::make()->schema([
                    Section::make('Order Information')->schema([
                        ...
                        ToggleButtons::make('status')->inline()->default('new')
                            ->options([
                                'new' => 'New',
                        ...
                        Select::make('shipping_method')->options([
                            ...
                            'UPS' => 'UPS',
                            'DHL' => 'DHL',
                            'Pick-up' => 'In Store Pick-up'
                        ])->required()->default('pickup'),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                TextColumn::make('currency')->searchable()->sortable()->formatStateUsing(fn (?string $state): string => strtoupper($state ?? '')),
